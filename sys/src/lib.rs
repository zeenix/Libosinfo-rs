// This file was generated by gir (e4452ea) from gir-files (???)
// DO NOT EDIT
...
#[repr(C)]
pub enum OsinfoDeviceDriverSigningReq {
    None = 0,
    Strict = 1,
    Warn = 2,
}
pub const OSINFO_DEVICE_DRIVER_SIGNING_REQ_NONE: OsinfoDeviceDriverSigningReq = OsinfoDeviceDriverSigningReq::None;
pub const OSINFO_DEVICE_DRIVER_SIGNING_REQ_STRICT: OsinfoDeviceDriverSigningReq = OsinfoDeviceDriverSigningReq::Strict;
pub const OSINFO_DEVICE_DRIVER_SIGNING_REQ_WARN: OsinfoDeviceDriverSigningReq = OsinfoDeviceDriverSigningReq::Warn;

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
#[repr(C)]
pub enum OsinfoInstallConfigParamPolicy {
    None = 0,
    Required = 1,
    Optional = 2,
}
pub const OSINFO_INSTALL_CONFIG_PARAM_POLICY_NONE: OsinfoInstallConfigParamPolicy = OsinfoInstallConfigParamPolicy::None;
pub const OSINFO_INSTALL_CONFIG_PARAM_POLICY_REQUIRED: OsinfoInstallConfigParamPolicy = OsinfoInstallConfigParamPolicy::Required;
pub const OSINFO_INSTALL_CONFIG_PARAM_POLICY_OPTIONAL: OsinfoInstallConfigParamPolicy = OsinfoInstallConfigParamPolicy::Optional;

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
#[repr(C)]
pub enum OsinfoMediaError {
    NoDescriptors = 0,
    NoPvd = 1,
    NoSvd = 2,
...
pub const OSINFO_MEDIA_ERROR_NO_DESCRIPTORS: OsinfoMediaError = OsinfoMediaError::NoDescriptors;
pub const OSINFO_MEDIA_ERROR_NO_PVD: OsinfoMediaError = OsinfoMediaError::NoPvd;
pub const OSINFO_MEDIA_ERROR_NO_SVD: OsinfoMediaError = OsinfoMediaError::NoSvd;
pub const OSINFO_MEDIA_ERROR_INSUFFICIENT_METADATA: OsinfoMediaError = OsinfoMediaError::InsufficientMetadata;
pub const OSINFO_MEDIA_ERROR_NOT_BOOTABLE: OsinfoMediaError = OsinfoMediaError::NotBootable;

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
#[repr(C)]
pub enum OsinfoPathFormat {
    Unix = 0,
    Dos = 1,
}
pub const OSINFO_PATH_FORMAT_UNIX: OsinfoPathFormat = OsinfoPathFormat::Unix;
pub const OSINFO_PATH_FORMAT_DOS: OsinfoPathFormat = OsinfoPathFormat::Dos;

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
#[repr(C)]
pub enum OsinfoProductRelationship {
    DerivesFrom = 0,
    Upgrades = 1,
    Clones = 2,
}
pub const OSINFO_PRODUCT_RELATIONSHIP_DERIVES_FROM: OsinfoProductRelationship = OsinfoProductRelationship::DerivesFrom;
pub const OSINFO_PRODUCT_RELATIONSHIP_UPGRADES: OsinfoProductRelationship = OsinfoProductRelationship::Upgrades;
pub const OSINFO_PRODUCT_RELATIONSHIP_CLONES: OsinfoProductRelationship = OsinfoProductRelationship::Clones;

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
#[repr(C)]
pub enum OsinfoReleaseStatus {
    Released = 0,
    Snapshot = 1,
    Prerelease = 2,
}
pub const OSINFO_RELEASE_STATUS_RELEASED: OsinfoReleaseStatus = OsinfoReleaseStatus::Released;
pub const OSINFO_RELEASE_STATUS_SNAPSHOT: OsinfoReleaseStatus = OsinfoReleaseStatus::Snapshot;
pub const OSINFO_RELEASE_STATUS_PRERELEASE: OsinfoReleaseStatus = OsinfoReleaseStatus::Prerelease;
...
bitflags! {
    ...
    pub struct OsinfoInstallScriptInjectionMethod: c_uint {
        const OSINFO_INSTALL_SCRIPT_INJECTION_METHOD_CDROM = 1;
        const OSINFO_INSTALL_SCRIPT_INJECTION_METHOD_DISK = 2;
        const OSINFO_INSTALL_SCRIPT_INJECTION_METHOD_FLOPPY = 4;
        const OSINFO_INSTALL_SCRIPT_INJECTION_METHOD_INITRD = 8;
        const OSINFO_INSTALL_SCRIPT_INJECTION_METHOD_WEB = 16;
    }
}
